                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="./blog_details.html">
                                        <img src="{{ asset('website_assets/images/news1.jpg') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="card__post-carousel">
                            <div class="item">
                                ...
                                <div class="card__post">
                                    <div class="card__post__body">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('website_assets/images/newsimage1.png') }}" class="img-fluid" alt="">
                                        </a>
                            ...
                            <div class="item">
                                ...
                                <div class="card__post">
                                    <div class="card__post__body">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('website_assets/images/newsimage2.png') }}" class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                                                covid-19
                        ...
                        <div class="popular__news-right">
                            ...
                            <div class="card__post ">
                                <div class="card__post__body card__post__transition">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('website_assets/images/newsimage3.png') }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="card__post__content bg__post-cover">
                                        <div class="card__post__category">
                                            politics
                            ...
                            <div class="card__post ">
                                <div class="card__post__body card__post__transition">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('website_assets/images/newsimage4.png') }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="card__post__content bg__post-cover">
                                        <div class="card__post__category">
                                            politics
                        ...
                        <div class="top__news__slider">
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('website_assets/images/newsimage5.png') }}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('website_assets/images/newsimage6.png') }}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                                        <ul class="list-inline">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('website_assets/images/newsimage7.png') }}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                                        <ul class="list-inline">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('website_assets/images/newsimage8.png') }}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                                        <ul class="list-inline">
                        ...
                        <div class="row ">
                            <div class="col-sm-12 col-md-6 mb-4">
                                ...
                                <div class="card__post ">
                                    <div class="card__post__body card__post__transition">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('website_assets/images/newsimage8.png') }}" class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                                                politics
                            ...
                            <div class="col-sm-12 col-md-6 mb-4">
                                ...
                                <div class="card__post ">
                                    <div class="card__post__body card__post__transition">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('website_assets/images/newsimage9.png') }}" class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                                                politics
                    ...
                    <div class="article__entry-carousel">
                        <div class="item">
                            ...
                            <div class="article__entry">
                                <div class="article__image">
                                    <a href="#">
                                        <img src="{{ asset('website_assets/images/newsimage9.png') }}" alt="" class="img-fluid">
                                    </a>
                                </div>
                                <div class="article__content">
                                    <ul class="list-inline">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage1.png') }}" alt="" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                                                <ul class="list-inline">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage2.png') }}" alt="" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                                                <ul class="list-inline">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage4.png') }}" alt="" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                                                <ul class="list-inline">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-5">
                                            <div class="card__post__transition">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage6.png') }}" class="img-fluid w-100" alt="">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card__post card__post-list card__post__transition mt-30">
                                    <div class="row ">
                                        <div class="col-md-5">
                                            <div class="card__post__transition">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage8.png') }}" class="img-fluid w-100" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-7 my-auto pl-0">
                                ...
                                <div class="card__post card__post-list card__post__transition mt-30">
                                    <div class="row ">
                                        <div class="col-md-5">
                                            <div class="card__post__transition">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage9.png') }}" class="img-fluid w-100" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-7 my-auto pl-0">
                                ...
                                <div class="card__post card__post-list card__post__transition mt-30">
                                    <div class="row ">
                                        <div class="col-md-5">
                                            <div class="card__post__transition">
                                                <a href="#">
                                                    <img src="{{ asset('website_assets/images/newsimage1.png') }}" class="img-fluid w-100" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-7 my-auto pl-0">
